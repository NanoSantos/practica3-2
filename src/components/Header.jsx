...
// Interfaz al resetear la página
const Header = ({ gastos, setGastos, presupuesto,  setPresupuesto,  isValidPresupuesto,  setIsValidPresupuesto }) => {
    ...
    // setIsValidPresupuesto.- funcion que actualiza la var. de estado, APP
    return (
        <header>
            <h1>Planificador de Gastos</h1>
            {/* Validando isValidPresupuesto para que muestre la otra pagina*/}
            { isValidPresupuesto ? (
                <ControlPresupuesto 
                    gastos={gastos}
                    setGastos={setGastos}
